    ...
    <section className="relative min-h-screen bg-white flex items-center overflow-hidden">
      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-20 py-16 sm:py-24 max-w-7xl relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Coluna de Texto */}
          <div className="space-y-6 text-center lg:text-left text-white lg:text-black drop-shadow-[0_1.5px_1.5px_rgba(0,0,0,0.35)] lg:drop-shadow-none">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-semibold leading-none tracking-tight">
              Aprenda <span className="text-primary">Inglês</span> de forma natural e eficiente
            </h1>

            <p className="sm:text-white/85 lg:text-gray-500 sm:text-lg lg:text-lg leading-relaxed max-w-xl mx-auto lg:mx-0">
            ...
            {/* Estatísticas - Ajuste para Mobile */}
            <div className="flex flex-wrap sm:flex-nowrap justify-center lg:justify-start gap-8 sm:gap-12 pt-12 mt-12 border-t border-black/10">
          ...
          {/* Coluna de Imagem, somente visível no desktop */}
