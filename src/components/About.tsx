  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white via-amber-50/30 to-white overflow-hidden">
      <div className="container mx-auto px-6 sm:px-10 lg:px-20 max-w-7xl">
        {/* 👇 items-stretch faz ambas as colunas terem mesma altura */}
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-stretch">
          ...
          <div className="relative flex justify-center items-center order-2 lg:order-1">
            ...
            {/* 👇 A imagem agora se ajusta automaticamente à altura da direita */}
            <div className="relative rounded-3xl overflow-hidden shadow-2xl w-full h-full flex">
              <img
                src={aboutImage}
            ...
            <div className="flex flex-col gap-6 mb-8 sm:mb-10">
              {highlights.map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-start gap-4 sm:gap-5 text-left"
                  >
