...
const Plans = () => {
    ...
    const messageExecutivePlane = "💼 Oi! Tenho interesse no Plano Executivo e gostaria de saber como funciona o processo para começar as aulas.";
    ...
    const plans = [
        {
            ...
            highlighted: false,
            buttonMessage: messageEssencialPlane
        },
        {
            name: 'Premium',
            price: 'R$ 529',
            ...
            highlighted: true,
            buttonMessage: messagePremiumPlane
        },
        {
            name: 'Executive',
            price: 'R$ 717',
            ...
            highlighted: false,
            buttonMessage: messageExecutivePlane
        }
    ];
                                ...
                                <div className={`h-full rounded-3xl p-8 transition-all duration-500 group-hover:-translate-y-2 relative overflow-hidden ${plan.highlighted
                                    ...
                                    <div className="relative">
                                        ...
                                        <button className={`w-full py-4 rounded-xl font-semibold transition-all duration-300 mb-8 ${plan.highlighted
                                            ...
                                            <a href={`https://wa.me/${phoneNumber}?text=${encodeURIComponent(plan.buttonMessage)}`} target="_blank">Começar Agora</a>
                                        </button>
