...
const ShimmerComponent = ({
  ...
  spread = 2,
  repeatDelay = 0,
  baseGradient = "linear-gradient(var(--color-muted-foreground), var(--color-muted-foreground))",
}: TextShimmerProps) => {
  ...
  return (
    <MotionComponent
      ...
      className={cn(
        ...
        "[--bg:linear-gradient(125deg,#0000_calc(50%-var(--spread)),var(--color-background),#0000_calc(50%+var(--spread)))] [background-repeat:no-repeat,padding-box]",
        className,
      )}
